...
<div class="row">
		...
		<h1 style="padding-bottom: 20px"></h1>
            ...
            <ol class="breadcrumb">
				<li><a href="create_sponsor.php">Add Sponsor</a></li>
...
if ($result->num_rows > 0) {	
    ...
    while($row = $result->fetch_assoc()) {
        ...
        echo '<tr><td><a href="display_sponsor.php?id='.$row['sponsor_id'].'">'.$row['sponsor_first_name']." ".$row['sponsor_last_name'].'</a></td>
		...
		<td>".$row["sponsor_notes"]."</td>";
		
		echo '<td><a href="edit_sponsor.php?id='.$row['sponsor_id'].'"><img class="img-responsive" src="ProjectManagementSystem/project_image/edit.png" width="200" height="200" alt=""></a></td>';

		echo '<td><a href="delete_sponsor.php?id='.$row['sponsor_id'].'"><img class="img-responsive" src="ProjectManagementSystem/project_image/delete.png" width="200" height="200" alt=""></a></td></tr>';
