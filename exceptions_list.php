...
<head>
    ...
    <title><?php echo $parameters['systemname']->value ?> List Exceptions</title>
...
<div class="row">
		...
		<h1 style="padding-bottom: 20px"></h1>
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Exceptions List</li>
            </ol>
...
$sql = "SELECT * FROM inventory_item WHERE image = '' OR price = '' OR numPages = '' OR numPages = 0 OR publishYear = ''";
