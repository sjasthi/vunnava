...
<head>
    ...
    <title><?php echo $parameters['systemname']->value ?> View Edited Sponsor</title>
    <!-- Bootstrap Core CSS -->
...
<div class="row">
		...
		<h1 style="padding-bottom: 20px"></h1>
            <h3 class="page-header">
                ...
                The sponsor has been edited in the database.
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Sponsor Edited</li>
            </ol>
...
<?php
    require 'ProjectManagementSystem/configure.php';
		...
		$sponsor_id = "";
		$sponsor_first_name = $_SESSION['confirmation_sponsor_first_name'];
		$sponsor_last_name = $_SESSION['confirmation_sponsor_last_name'];
		$email = $_SESSION['confirmation_email'];
		$phone = $_SESSION['confirmation_phone'];
		$bio = $_SESSION['confirmation_bio'];
		$address = $_SESSION['confirmation_address'];
		$sponsor_notes = $_SESSION['confirmation_sponsor_notes'];
		$photo = $_SESSION['confirmation_photo'];
