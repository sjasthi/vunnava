...
<head>
    ...
    <title><?php echo $parameters['systemname']->value ?> View Edited Project</title>
    <!-- Bootstrap Core CSS -->
...
<div class="row">
		...
		<h1 style="padding-bottom: 20px"></h1>
            <h3 class="page-header">
                ...
                The project has been edited in the database.
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Project Edited</li>
            </ol>
...
<?php
    require 'ProjectManagementSystem/configure.php';
		...
		$project_id = "";
		$project_name = $_SESSION['confirmation_project_name'];
		$proposed_by = $_SESSION['confirmation_proposed_by'];
		$proposed_end_date = $_SESSION['confirmation_proposed_end_date'];
		$proposed_start_date = $_SESSION['confirmation_proposed_start_date']; 
		$description = $_SESSION['confirmation_description'];
		$project_notes = $_SESSION['confirmation_project_notes'];
		$project_type = $_SESSION['confirmation_project_type'];
		$frequency = $_SESSION['confirmation_frequency']; 
		$actual_end_date = $_SESSION['confirmation_actual_end_date'];
		$actual_start_date = $_SESSION['confirmation_actual_start_date'];
		$project_status = $_SESSION['confirmation_project_status'];
		$project_image = $_SESSION['confirmation_project_image'];
		$project_image_url = $_SESSION['confirmation_project_image_url'];
