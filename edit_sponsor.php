...
<head>
    ...
    <title><?php echo $parameters['systemname']->value ?> Edit Sponsor</title>
    <!-- Bootstrap Core CSS -->
...
<div class="row">
		...
		<h1 style="padding-bottom: 20px"></h1>
            ...
            <ol class="breadcrumb">
			<li><a href="sponsor_list.php">Cancel Edit Sponsor</a></li>
...
// If no errors, go to confirmation page
	...
	// Run Query
		if(isset($_POST['submit'])){
	$sql = "UPDATE sponsor SET sponsor_first_name = '$sponsor_first_name', sponsor_last_name = '$sponsor_last_name', email = '$email',
	phone = '$phone', bio = '$bio', 
	address = '$address', sponsor_notes = '$sponsor_notes', 
	photo = '$photo'
...
//Close Connection
			...
			header('Location: view_edited_sponsor.php');
		}
...
//get project data from database to populate fields with values
	$id = $_GET['id'];
	$sql = "SELECT * FROM sponsor WHERE sponsor_id = '$id'";
		$result = $conn->query($sql);
		 while($row = $result->fetch_assoc()) {
			...
			$edit_sponsor_notes= $row["sponsor_notes"];
		}
?>
...
<tr>
<td>
<input type="text" name="sponsor_id" value="<?php echo $edit_sponsor_id;?>" value="<?php echo $sponsor_id;?>"readonly>
</td>
</tr>
...
<tr>
<td>
<input type="text" name="sponsor_first_name" value="<?php echo $edit_sponsor_first_name;?>" value="<?php echo $sponsor_first_name;?>">
...
<tr>
<td>
<input type="text" name="sponsor_last_name" value="<?php echo $edit_sponsor_last_name;?>" value="<?php echo $sponsor_last_name;?>">
...
<tr>
<td>
<input type="text" name="phone" value="<?php echo $edit_phone;?>" value="<?php echo $phone;?>">
</td>
</tr>
...
<tr>
<td>
<input type="text" name="email" value="<?php echo $edit_email;?>" value="<?php echo $email;?>">
</td>
</tr>
...
<tr>
<td>
<textarea name="bio" rows="3" cols="40" maxlength="5000"><?php echo $edit_bio;?><?php echo $bio;?></textarea>
</td>
</tr>
...
<tr>
<td>
<textarea name="address" rows="3" cols="40" maxlength="5000"><?php echo $edit_address;?><?php echo $address;?></textarea>
</td>
</tr>
...
<tr>
<td>
<textarea name="sponsor_notes" rows="3" cols="40" maxlength="5000"><?php echo $edit_sponsor_notes;?><?php echo $sponsor_notes;?></textarea>
</td>
</tr>
...
<tr>
<td>
<label>New Sponsor Picture: </label>
</td>
</tr>
<tr>
<td>
...
<!-- Sponsor Current Image Input -->
<tr>
<td>
<label>Current Sponsor Picture: </label>
</td>
</tr>
<tr>
<td>
<input type="text" size="50" name="photo" value="<?php echo $edit_photo;?>" value="<?php echo $photo;?>"readonly>
</td>
</tr>
...
<tr>
<td>
<input class="orange_button" type="submit" name="submit" value="Update Sponsor">
</td>
</tr>
