...
$conn->close();
	header('Location: sponsorship_list.php');
}

echo "<h3>Sponsorship ID: $id</h3>";

echo '
<form method="post" action="">
<input type="submit" class="orange_button" name="submit" value="Yes">
<!-- No Button -->
<a href="sponsorship_list.php" id="noButton" class="orange_button">Cancel</a>
</form>
';
?>
