...
<head>
    ...
    <title><?php echo $parameters['systemname']->value ?> List Books</title>
...
<div class="row">
		...
		<h1 style="padding-bottom: 20px"></h1>
            ...
            <ol class="breadcrumb">
				<li><a href="BookEdit.php?libraryID=0">Add Book</a></li>
...
$sql = "SELECT id, title, author, donatedBy, image FROM inventory_item";
